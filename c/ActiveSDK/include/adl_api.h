...
#define ADL_DISABLE  0
   ...
   /* To improve accuracy for packed data */
   struct strBytesPerPixel {
      uint32_t m_dwNumerator;
      uint32_t m_dwDenominator;
   };
   ...
   /*! ADL Bayer decode types */
   typedef enum {
      /*! Use Pixel Duplication. */
      ADL_BAYER_DUP = 1,
   ...
   typedef enum {
      ...
      ADL_PIXEL_FORMAT_MONO14P = 0xC0022622,
      ...
      ADL_PIXEL_FORMAT_MONO12P,
      ADL_PIXEL_FORMAT_BAYER_GR10P,
      ADL_PIXEL_FORMAT_BAYER_RG10P,
      ADL_PIXEL_FORMAT_BAYER_GB10P,
      ADL_PIXEL_FORMAT_BAYER_BG10P, 
      ADL_PIXEL_FORMAT_BAYER_GR12P,
      ADL_PIXEL_FORMAT_BAYER_RG12P,
      ADL_PIXEL_FORMAT_BAYER_GB12P,
      ADL_PIXEL_FORMAT_BAYER_BG12P,
      ADL_PIXEL_FORMAT_BAYER_GR14P,
      ADL_PIXEL_FORMAT_BAYER_RG14P,
      ADL_PIXEL_FORMAT_BAYER_GB14P,
      ADL_PIXEL_FORMAT_BAYER_BG14P
   } etADLPixelFormat;
   ...
   typedef enum {
      ...
      *!*/
      ...
      ADL_DISPLAY_FN_CALLBACK,

      ADL_DISPLAY_CALLBACK_CONTEXT,
      /*! Display Bayer Decode algorithm.
      *! Argument type: etADLBayerDecode *.
      */
      ADL_DISPLAY_BAYER_DECODE
   } etADLDisplayParam;
